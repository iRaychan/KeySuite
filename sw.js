const CACHE='keysuite-chc-v017';
const FILES=['./','index.html','app.js','manifest.json','selector/index.html','selector/favicon.png','selector/apple-touch-icon.png','selector/bgreich-logo.png','keylargo-logo.png'];
