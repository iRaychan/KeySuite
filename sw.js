const CACHE='keysuite-v1.16-pricelist-signatory-1';
const SHELL=['./','./index.html','./app.js','./pricing.js','./categories.js','./pricelist.js','./roles.js','./auth.js','./manifest.json','./keylargo-logo.png'];
