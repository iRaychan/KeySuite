const CACHE='keysuite-v1.15-category-layout-currency-1';
const SHELL=['./','./index.html','./app.js','./pricing.js','./categories.js','./roles.js','./auth.js','./manifest.json','./keylargo-logo.png'];
